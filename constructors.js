...
// Code here
// remember to add new infront of new instances
...
User.prototype.addSavedPost = function(id, title, rating) {
  // add to savedPosts array, pushing in an object
...
User.prototype.removeSavedPost = function(id) {
  // find the id in the savedPosts array and store in a variable called index
  let index = this.savedPosts.findIndex(i => i.id === id);
  // remove the post with the matching id
  this.savedPosts.splice(index, 1);
  // return the updated savedPOsts array
  return this.savedPosts;
};
...
// Write a prototype method for the User constructor function named changePostRating that will take in two number parameters. The first will be an id (a number) and the second will be the new rating (a number). Use the id to find the matching object in the savedPosts array.
...
User.prototype.changePostRating = function(id, rating) {
  // find the matching id in the savedPosts array and store in the variable called index
  let index = this.savedPosts.findIndex(i => i.id === id);
  // store the updated rating in the selected/accessed object
  this.savedPosts[index].rating = rating;
  // store in updatedRating variable
  let updatedRating = this.savedPosts;
